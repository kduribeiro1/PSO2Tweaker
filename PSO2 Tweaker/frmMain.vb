...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If String.IsNullOrEmpty(Helper.GetRegKey("HKEY_CURRENT_USER\Software\AIDA", "PSO2Dir", Nothing)) Then
            ...
            If String.IsNullOrEmpty(Helper.GetRegKey("HKEY_CURRENT_USER\Software\AIDA", "PSO2Dir", Nothing)) Then
                ...
                Button1.RaiseClick()
            Else
                lblDirectory.Text = Helper.GetRegKey("HKEY_CURRENT_USER\Software\AIDA", "PSO2Dir", lblDirectory.Text)
            ...
            If lblDirectory.Text.Contains("\pso2_bin\data\win32") = True Then
                If File.Exists(lblDirectory.Text.Replace("\data\win32", "") & "\pso2.exe") = True Then
                    ...
                    Helper.SetRegKey("HKEY_CURRENT_USER\Software\AIDA", "PSO2Dir", lblDirectory.Text)
...
SelectPSO2Folder:
            ...
            ' End If
            Helper.SetRegKey("HKEY_CURRENT_USER\Software\AIDA", "PSO2Dir", MyFolderBrowser.SelectedPath)
