...
Public Class frmDiagnostic
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim drInfo As New DirectoryInfo(Helper.GetRegKey(Of String)(RegKey.PSO2Dir) & "\data\win32\")
        ...
        Dim totalString As String = ""
        totalString &= "PSO2 Directory: " & Helper.GetRegKey(Of String)(RegKey.PSO2Dir) & vbCrLf
        totalString &= "Current game version: " & Helper.GetRegKey(Of String)(RegKey.PSO2RemoteVersion) & vbCrLf
        totalString &= "Item Translation: " & Helper.GetRegKey(Of String)(RegKey.UseItemTranslation) & vbCrLf
        totalString &= "EN Patch version installed: " & Helper.GetRegKey(Of String)(RegKey.ENPatchVersion) & vbCrLf
        totalString &= "Large Files version installed: " & Helper.GetRegKey(Of String)(RegKey.LargeFilesVersion) & vbCrLf
        totalString &= "Story Patch version installed: " & Helper.GetRegKey(Of String)(RegKey.StoryPatchVersion) & vbCrLf
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim drInfo As New DirectoryInfo(Helper.GetRegKey(Of String)(RegKey.PSO2Dir))
