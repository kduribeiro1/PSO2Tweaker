...
Public Class FrmVeda
    ...
    Private Shared Sub Log(output As String)
        File.AppendAllText((Program.StartPath & "\logfile.txt"), DateTime.Now.ToString("G") & ": " & output & vbCrLf)
    End Sub

    Private Sub WriteConsoleAndOk(str As String)
        WriteDebugInfoAndOk(str)
        Application.DoEvents()
        Thread.Sleep(Helper.GetRandom(30, 1000))
    End Sub
    ...
    Private Sub btnListDir_Click(sender As Object, e As EventArgs) Handles btnListDir.Click
        ...
        Dim pso2Launchpath As String = Program.MainForm.lblDirectory.Text.Replace("\data\win32", "")
