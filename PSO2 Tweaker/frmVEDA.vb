Public Class frmVEDA
    ...
    Public Sub Log(ByRef Text As String)
        ...
        System.IO.File.AppendAllText((Application.StartupPath & "\logfile.txt"), TimeFormatted & ": " & Text & vbCrLf)
    End Sub
    ...
    Private Sub frmVEDA_Move(sender As Object, e As EventArgs) Handles Me.Move
    ...
    Private Sub btnListDir_Click(sender As Object, e As EventArgs) Handles btnListDir.Click
        ...
        System.IO.File.Delete("PSO2 Folder Contents.txt")
        'list the names of all files in the specified directory
        For Each dra In diar1
            System.IO.File.AppendAllText("PSO2 Folder Contents.txt", (dra.ToString & vbCrLf))
        Next
    ...
    Private Sub btnAnyDir_Click(sender As Object, e As EventArgs) Handles btnAnyDir.Click
        ...
        Dim diar1 As IO.FileInfo() = di.GetFiles()
        Dim dra As IO.FileInfo
        System.IO.File.Delete("Folder Contents.txt")
        'list the names of all files in the specified directory
        For Each dra In diar1
            System.IO.File.AppendAllText("Folder Contents.txt", (dra.ToString & vbCrLf))
        Next
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        'list the names of all files in the specified directory
        For Each dra In diar1
            System.IO.File.AppendAllText(DirectoryString & " \Story MD5HashList.txt", (dra.ToString & "," & GetMD5(DirectoryString & " \" & dra.ToString) & vbCrLf))
        Next
        WriteDebugInfo("Done.")
