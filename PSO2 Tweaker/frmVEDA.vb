...
Public Class FrmVeda
    ...
    Private Shared Sub Log(output As String)
        File.AppendAllText((My.Program.StartPath & "\logfile.txt"), DateTime.Now.ToString("G") & ": " & output & vbCrLf)
    End Sub
    ...
    Private Sub btnListDir_Click(sender As Object, e As EventArgs) Handles btnListDir.Click
        ...
        Dim pso2Launchpath As String = My.Program.MainForm.lblDirectory.Text.Replace("\data\win32", "")
    ...
    Private Sub btnDLWUA_Click(sender As Object, e As EventArgs) Handles btnDLWUA.Click
        My.Program.MainForm.DownloadFile(txtAqua.Text, "testfile")
    End Sub
End Class